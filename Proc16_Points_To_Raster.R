...
Country<-readOGR("C:\\Users\\au704633\\OneDrive - Aarhus Universitet\\Documents\\AARHUS_PhD\\DSMactivities\\1_SOCseq\\INPUTS\\SHP\\LIMIT\\LIMIT.shp")
Country <- sp::spTransform(Country,CRS("+proj=longlat +datum=WGS84 +no_defs"))
...
UNC_abs_rate_BAU <- ifelse(is.nan(UNC_abs_rate_BAU),
                               999,
                           UNC_abs_rate_BAU)
...
UNC_abs_rate_Lw <- ifelse(is.nan(UNC_abs_rate_Lw),
                           999,
                          UNC_abs_rate_Lw)
...
UNC_abs_rate_Md <- ifelse(is.nan(UNC_abs_rate_Md),
                          999,
                          UNC_abs_rate_Md)
...
UNC_abs_rate_Hg <- ifelse(is.nan(UNC_abs_rate_Hg),
                          999,
                          UNC_abs_rate_Hg)
...
UNC_Rel_rate_Lw <- ifelse(is.nan(UNC_Rel_rate_Lw),
                          999,
                          UNC_Rel_rate_Lw)
...
UNC_Rel_rate_Md <- ifelse(is.nan(UNC_Rel_rate_Md),
                          999,
                          UNC_Rel_rate_Md)
...
UNC_Rel_rate_Hg <- ifelse(is.nan(UNC_Rel_rate_Hg),
                          999,
                          UNC_Rel_rate_Hg)
